...
// let arryaList = ['Abbos','Madina','Yasmina','Ulugbek','Oybek','Aziz','Matlyuba'];

// let othersName = ['Tohir', 'Murod','Alisher',];

// let resultDate = arryaList.concat(othersName);

// console.log(resultDate.sort());
